...
p3 = 0.05 ##probability of dropping rate about the antidote
awareness = 3000
r = 1
                ...
                if num >= awareness:
                    for dx in range(-r, r+1):
                        for dy in range(-r, r+1):
                            ...
                            if n1>= 1:
                                status2[x,y] = 2 if random() <= p21 else status[x,y]
                            else:
                                status2[x,y] = status[x,y]
                else:
                    status2[x,y] = status[x,y]
                ...
                if num >= awareness:
                    for dx in range(-r, r+1):
                        for dy in range(-r, r+1):
                            ...
                            if n2>= 1:
                                status2[x,y] = 2 if random() <= p22 else status[x,y]
                            else:
                                status2[x,y] = status[x,y]
                else:
                    status2[x,y] = status[x,y]
                ...
                if num >= awareness:
                    ...
                    if random() <= p3:
                        ...
                        for dx in range(-r, r+1):
                            for dy in range(-r, r+1):                      
                                if 0 <= x+dx < L and 0 <= y+dy < L:
                                    n3 += 1 if status[x+dx, y+dy] in [3,4,5] else 0
                                status2[x, y] = np.random.choice([1,3,4,5], p=[1-p11-p12-p13,p11,p12,p13]) if n3 > 0 else 1
                    ...
                    for dx in range(-r, r+1):
                        for dy in range(-r, r+1):
                            if 0 <= x+dx < L and 0 <= y+dy < L:
                                ...
                                n4 += np.random.choice([1,3,4,5], p=[1-p11-p12-p13,p11,p12,p13]) if status[x+dx, y+dy] >= 3 else 0
                            if n4 == 1:
                                status2[x, y] = 1
                            elif n4 >= 2:
