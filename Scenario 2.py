                    ...
                    if num <= awareness+20:
                        ...
                        if random() <= p3:
                             for dx in range(-r, r+1):
                                for dy in range(-r, r+1):                      
                                    if 0 <= x+dx < L and 0 <= y+dy < L:
                                        n3 += 1 if status[x+dx, y+dy] == 2 else 0
                            ...
                            for dx in range(-r, r+1):
                                for dy in range(-r, r+1):                      
                                    if 0 <= x+dx < L and 0 <= y+dy < L:
                                        n4 += 1 if status[x+dx, y+dy] in [3,4,5] else 0
                                status2[x, y] = np.random.choice([1,3,4,5], p=[1-p11-p12-p13,p11,p12,p13]) if n4 > 0 else 1
                    ...
                    for dx in range(-r, r+1):
                        for dy in range(-r, r+1):
                            if 0 <= x+dx < L and 0 <= y+dy < L:
                                ...
                                n5 += np.random.choice([1,3,4,5], p=[1-p11-p12-p13,p11,p12,p13]) if status[x+dx, y+dy] >= 3 else 0
                            if n5 == 1:
                                status2[x, y] = 1
                            elif n5 >= 2:
